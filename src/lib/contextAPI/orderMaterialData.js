...
export const OrderMaterialContext = createContext();

export const OrderMaterialProvider = ({ children }) => {
  ...
  return (
    <OrderMaterialContext.Provider value={{ orderMaterial, setorderMaterial, totalAmount, totalQty, cashTypeTable, setcashTypeTable }}>
      {children}
    </OrderMaterialContext.Provider>
  );
};
