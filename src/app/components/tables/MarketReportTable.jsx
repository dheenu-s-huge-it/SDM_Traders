...
const MarketReport = ({
  ...
  return (
    <BaseCard sx={{ padding: "0px !important", minWidth: "100vw !important" }}>
      ...
      <Stack>
        <Collapse in={filtersList} sx={{ width: 1, marginTop: "10px" }}>
          ...
          >
            <TableHead size="small">
              <TableRow size="small">
                ...
                {tableHead?.map((headCell,headindex) =>
                  filterData?.some((res) => res.label === headCell.label) ? (
                    headCell.subColumns && headCell.subColumns.length > 0 ? (
                      <TableCell align="center" key={headCell.id}>
                        ...
                        >
                          {headCell.subColumns.map((subColumn) => (
                            <TableCell
                              key={subColumn.value}
                              align="center"
                              sx={{
              ...
              {isLoading ? (
                ...
                tableRow.slice(0, limitEnd)?.map((row, index) => (
                  <TableRow hover key={index}>
                    ...
                    {/* Accessing subcolumn data.  Adjust as needed for your data structure */}
                    {row.trader_payment && (
                      <>
                        <TableCell>
                          {row.trader_payment.advance_payment}
                        </TableCell>
                        <TableCell>{row.trader_payment.full_payment}</TableCell>
                      </>
                    )}
                    <TableCell align="center">
                      <Typography
