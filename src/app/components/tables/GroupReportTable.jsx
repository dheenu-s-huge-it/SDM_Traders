...
import SearchGroupFilter from "../buttons/SearchGroupFilter";
...
const GroupReportTable = ({
  ...
  // inside GroupReportTable component
const handlePrintAll = () => {
  if (Object.keys(selectedItems).length > 0) {
    handlePrintMulitple(excelData);
  } else {
    handlePrintMulitple();
  }
};
          ...
          >
            ...
            >
              <Typography variant="button" fontWeight={700}>
                ...
                >
                 ₹ {totalData?.total_amount?.toFixed(2)}
                </span>
              </Typography>
              ...
              <Typography variant="button" fontWeight={700}>
                ...
                >
                 ₹ {totalData?.total_net_amount?.toFixed(2)}
                </span>
              </Typography>
            </Box>
          </TableCell>
