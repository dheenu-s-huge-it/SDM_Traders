                ...
                <TableRow>
                  <TableCell colSpan={tableHead.length + 1} align="center">
                    <Typography
                      ...
                      variant="h6"
                    >
                      Select the Trader and choose a Date.
                    </Typography>
                  </TableCell>
                </TableRow>
              ) : (
      ...
      {showTotals && isLoading === false && (
        <Box
          sx={{
            ...
            bottom: 0,
            backgroundColor:
              theme_org?.palette?.mode === "dark" ? "#1e1e2d" : "#fff",
            zIndex: 2,
          }}
        >
          <Box
          ...
          >
            ...
            >
              <Typography variant="button" fontWeight={700}>
                ...
                >
                  ₹ {totalData?.sub_amount?.toFixed(2) || "0.00"}
                </span>
              </Typography>
              ...
              <Typography variant="button" fontWeight={700}>
                ...
                >
                  ₹{" "}
                  {(
                    Math.round((Number(totalData?.total_amount) || 0) / 10) * 10
                  ).toFixed(2)}
                </span>
              </Typography>
            </Box>
...
export default ReportTableStatement;
