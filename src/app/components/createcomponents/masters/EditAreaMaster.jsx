...
function EditAreaMaster({ Header, route_back }) {
  const {
    control,
    handleSubmit,
    formState: { errors },
  ...
  const HandleEditGET = (value) => {
    if (value !== undefined && value !== null) {
      try {
        axiosGet
          .get(`master/areamaster/get?access_token=${token}&data_uniq_id=${value}`)
          .then((response) => {
  ...
  const handleSignIn = (e) => {
    ...
    try {
      axiosPost.put("master/areamaster/create", jsonStructure)
        .then((response) => {
              ...
              render={({ field }) => (
                <>
                  ...
                  <CustomTextField
                    ...
                    error={!!errorsMessage.area_name}
                    helperText={
                      errorsMessage.area_name ? errorsMessage.area_name : ""
                    }
                    sx={{ mb: 5 }}
                  />
                </>
