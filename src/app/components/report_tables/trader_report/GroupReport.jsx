              ...
              <div key={index}>
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ fontWeight: "600" }}>
                      {(traderWeekData.user_id || "").slice(-4)} -{" "}
                      {traderWeekData.trader_name || ""}
                    </span>
                  </div>
                  <div style={{ whiteSpace: "nowrap", paddingRight: "10px" }}>
                    Mobile:
                    <span style={{ fontWeight: "bold" }}>
                      {traderWeekData.mobile_number || "--"}
                    </span>
                  </div>
                </div>
                ...
                <div style={{ width: "100%", marginTop: "1px" }}>
                  ...
                  {Array.from({ length: 7 }, (_, idx) => {
                    const item = traderWeekData.trader_statement_data?.[idx];
                    return (
                      <div
                        key={idx}
                        style={{
                      ...
                      >
                        ...
                        <div>
                          {item ? Number(item.quantity || 0).toFixed(2) : ""}
                        </div>

                        <div>{item && Number(item.per_quantity)}</div>
                        <div>
                          {item && Number(item.sub_amount || 0).toFixed(2)}
                        </div>
                      </div>
                    );
                  })}
                  ...
                  >
                    ...
                    <span style={{ fontWeight: "600" }}>
                      ...
                      {traderWeekData.trader_statement_data
                        ?.reduce(
                          (sum, item) => sum + (item.sub_amount || 0),
                          0
                        )
                        .toFixed(2)}
                    </span>
