    ...
    <>
      ...
      <div style={{ display: "none" }}>
        ...
        >
            ...
            <tbody>
              ...
              <tr>
                <td colSpan={3} style={{ padding: "4px 6px" }}>
                  ...
                  <div>
                    <strong>To:</strong>{" "}
                   <span style={{fontWeight: 600}}> {singleDataJson?.trader_name || "Saiii Tharaaa"}</span>
                  </div>
          ...
          >
            <colgroup>
              <col style={{ width: "15%", backgroundColor: "green" }} />
              <col style={{ width: "20%", backgroundColor: "yellow" }} />
              <col style={{ width: "10%", backgroundColor: "purple" }} />
              <col style={{ width: "12%", backgroundColor: "blue" }} />
              <col style={{ width: "15%", backgroundColor: "red" }} />
              <col style={{ width: "15%", backgroundColor: "black" }} />
            </colgroup>
