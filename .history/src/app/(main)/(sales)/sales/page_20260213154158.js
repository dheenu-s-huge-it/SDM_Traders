...
const AllSales = () => {
  ...
  const formatDateTableData = (dateString) => {
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: "center", marginLeft: "10px" }}>
              ...
              <div style={{ margin: "1px 0", fontSize: "13px" }}>
                Erode - 638401, Ph.No: 94424 98222
                <p style={{ margin: "0" }}></p>
                {/* Aligned below the first number as per sketch */}
                <p style={{ margin: "0", paddingLeft: "48px" }}>80728 87930</p>
              </div>
                ...
                <td colSpan={3} style={{ padding: "4px 6px" }}>
                  ...
                  <div>
                    ...
                    <span style={{ fontWeight: "bolder" }}>
                      {" "}
                      {singleDataJson?.trader_name || "SDM MAHENDRAN"}
                    </span>
                  </div>
            ...
            <table className="items-table" style={{ borderTop: "none" }}>
              ...
              <tbody>
                <tr style={{ fontSize: "12px", textAlign: "center" }}>
                  <td>
                    {formatDateTableData(singleDataJson.date_wise_selling)}
                  </td>
