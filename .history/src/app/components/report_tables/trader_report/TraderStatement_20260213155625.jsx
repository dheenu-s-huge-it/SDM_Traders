            ...
            <>
              ...
              >
                ...
                <div style={{ textAlign: "center", marginLeft: "10px" }}>
                  ...
                  <p style={{ margin: "1px 0", fontSize: "13px" }}>
                    Erode - 638401, Ph.No: 94424 98222, 80728 87930
                  </p>
                    ...
                    <td colSpan={3} style={{ padding: "4px 6px" }}>
                      ...
                      <div>
                        ...
                        <span style={{ fontWeight: "bolder" }}>
                          {group[0]?.trader_name || "SDM MAHENDRAN"}
                        </span>
                      </div>

                      {/* Second Line - Right aligned */}
                      <div style={{ textAlign: "right" }}>
                        PH No : {group[0]?.mobile_number || "SDM MAHENDRAN"}
                      </div>
                    </td>
                  </tr>
                </tbody>
                ...
                <table className="items-table" style={{ borderTop: "none" }}>
                  ...
                  <tbody>
                    {group[0]?.trader_statement?.map((item, idx) => (
                      ...
                      >
                        <td>{formatDateTableData(item.date_wise_selling)}</td>
              ...
              >
                <tbody>
                  ...
                  <tr>
                    ...
                    >
                      <strong>
                        Amount in Words : {grantTotalInWords} Only{" "}
                      </strong>
                    </td>
                  </tr>
