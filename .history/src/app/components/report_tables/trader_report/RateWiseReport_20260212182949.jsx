        ...
        >
          {groupedPrintData.map(([key, trader], index) => (
            ...
            >
              ...
              >
                <colgroup>
                  <col style={{ width: "16%", backgroundColor: "yellow" }} />
                  <col style={{ width: "16%", backgroundColor: "red" }} />
                  <col style={{ width: "27%", backgroundColor: "purple" }} />
                  <col style={{ width: "5%", backgroundColor: "green" }} />
                  <col style={{ width: "5%", backgroundColor: "yellow" }} />
                </colgroup>
                <tr>
                  <td></td>
