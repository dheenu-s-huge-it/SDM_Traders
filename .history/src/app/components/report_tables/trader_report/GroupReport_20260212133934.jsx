                ...
                >
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      >
                        BILL DATE :{" "}
                        {traderWeekData.trader_statement_data[0]
                          ?.date_wise_selling
                          ? new Date(
                              traderWeekData.trader_statement_data[0]?.date_wise_selling
                            )
                    ...
                    <tr>
                      <td colSpan={3} style={{ padding: "4px 6px" }}>
                        ...
                        <div>
                          <strong>To:</strong>{" "}
                          {traderWeekData.trader_name || "Not found"}
                        </div>

                        {/* Second Line - Right aligned */}
                        <div style={{ textAlign: "right" }}>
                          PH No : {traderWeekData.mobile_number || "Not found"}
                        </div>
                      </td>
                    </tr>
                  </tbody>
