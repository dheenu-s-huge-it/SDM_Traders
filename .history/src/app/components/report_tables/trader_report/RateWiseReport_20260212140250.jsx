...
const RateWiseReport = () => {
  ...
  const handlePrintMultiple = () => {
    const printContent = multipleRef.current.innerHTML;
    const iframe = document.createElement("iframe");
      ...
      <Grid container spacing={2} sx={{ width: "100%" }}>
        <Grid item={12} sx={{ width: "100%" }}>
          <RateWiseTable
            ...
            handlePrintMultiple={handlePrintMultiple}
      ...
      <div style={{ display: "none" }}>
        ...
        >
          <div style={{ fontWeight: "bold", textAlign: "center" }}>
            சத்தி மலர் சாகுபடி விவசாயிகள் தலைமை சங்கம்
          </div>
          <div
            style={{
              marginTop: "5px",
            ...
            <div key={index} style={{ marginBottom: "12px" }}>
              ...
              >
                ...
                <tbody>
                  ...
                  >
                    ...
                    >
                      BILL DATE :{" "}
                      {group[0]?.date_wise_selling
                        ? new Date(group[0]?.date_wise_selling)
                            .toLocaleDateString("en-GB")
                            .replace(/\//g, "-")
                        : "" || ""}{" "}
                    </td>
              ...
              <div style={{ width: "100%", marginTop: "1px" }}>
                <div
                  style={{
                    display: "grid",
                    gridTemplateColumns: "3fr 3.5fr 3.5fr 3fr ",
                    width: "100%",
                  }}
                >
                  <div>S.No</div>
                ...
                {trader?.rate_wise?.map((item, idx) => (
                  ...
                  >
                    <div>{idx + 1}</div>
                    <div>{Number(item.total_quantity || 0).toFixed(0)}</div>
                    <div>{Number(item.rate || 0).toFixed(2)}</div>
                    <div>{Number(item.total_amount || 0).toFixed(0)}</div>
                  </div>
                ))}
              ...
              >
                <div
                  style={{
                    ...
                    fontWeight: "bold",
                    width: "100%",
                    maxWidth: "220px", // ✅ bigger safe width
                    whiteSpace: "nowrap",
                  }}
                >
                ...
                <div
                  style={{
                    ...
                    fontWeight: "bold",
                    width: "100%",
                    maxWidth: "220px", // Same width as above
                    whiteSpace: "nowrap",
                  }}
                >
                  <span>Net Total :</span>
