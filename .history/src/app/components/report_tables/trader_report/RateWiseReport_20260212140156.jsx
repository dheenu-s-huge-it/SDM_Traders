          ...
          {groupedPrintData.map(([key, trader], index) => (
            <div key={index} style={{ marginBottom: "12px" }}>
              ...
              >
                ...
                <tbody>
                  ...
                  >
                    ...
                    >
                      BILL DATE :{" "}
                      {trader[0]?.date_wise_selling
                        ? new Date(trader[0]?.date_wise_selling)
                            .toLocaleDateString("en-GB")
                            .replace(/\//g, "-")
                        : "" || ""}{" "}
                    </td>
                  ...
                  <tr>
                    <td colSpan={3} style={{ padding: "4px 6px" }}>
                      ...
                      <div>
                        <strong>To:</strong>{" "}
                        {trader[0]?.trader_name || "Not found"}
                      </div>

                      {/* Second Line - Right aligned */}
                      <div style={{ textAlign: "right" }}>
                        PH No : {trader[0]?.mobile_number || "Not found"}
                      </div>
                    </td>
                  </tr>
                </tbody>
              ...
              >
                ...
                {groupedPrintData.map(([key, trader], index) => {
                  const rateWiseStatement = trader[0]?.trader_statement || [];

                  const totals = calculateTraderTotals(rateWiseStatement);
                      ...
                      {(() => {
                        const grandTotal =
                          traderWeekData.trader_statement_data?.reduce(
                            (sum, item) =>
                              sum +
                              ((item.total_amount || 0) + (item.luggage || 0)),
                            0
                          ) || 0;
