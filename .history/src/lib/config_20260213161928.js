...
export const API_ENDPOINT = "https://traderapi.sdmflowers.in/";
// export const API_ENDPOINT = "http://192.168.0.111:8003/";
// export const API_ENDPOINT = "http://192.168.0.114:8002/";
export const IMG_ENDPOINT = "https://traderapi.sdmflowers.in/";
